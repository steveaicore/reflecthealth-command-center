...
export const VOLUME_PRESETS: Record<VolumePreset, { calls: number; claims: number }> = {
  low: { calls: 10000, claims: 15000 },
  medium: { calls: 29000, claims: 30000 },
  high: { calls: 50000, claims: 50000 },
};
